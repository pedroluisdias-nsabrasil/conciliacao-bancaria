...
def exemplo_niveis_confianca():
    ...
    match_alto = Match(
        lancamento=lancamento, comprovante=None, confianca=0.95, metodo="exato"
    )
    ...
    match_medio = Match(
        lancamento=lancamento, comprovante=None, confianca=0.80, metodo="fuzzy"
    )
    ...
    match_baixo = Match(
        lancamento=lancamento, comprovante=None, confianca=0.60, metodo="fuzzy"
    )
...
def exemplo_conciliacao_workflow():
    ...
    print("\n2. Criando match...")
    match = Match(
        lancamento=lancamento, comprovante=comprovante, confianca=0.93, metodo="exato"
    )
...
def exemplo_conversao_dict():
    ...
    lancamento = Lancamento(
        data=date(2025, 11, 2), valor=Decimal("100.00"), descricao="Teste", tipo="D"
    )
