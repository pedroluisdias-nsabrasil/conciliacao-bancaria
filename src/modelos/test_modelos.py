...
from src.modelos.comprovante import (
    Comprovante,
    ComprovanteError,
    ComprovanteInvalidoError,
    OCRError,
)
from src.modelos.match import (
    Match,
    MatchError,
    MatchInvalidoError,
...
class TestLancamento:
    ...
    def test_tipo_invalido(self):
        ...
        with pytest.raises(ValueError, match="Tipo deve ser 'D'.*ou 'C'"):
            Lancamento(
                data=date.today(), valor=Decimal("100"), descricao="Teste", tipo="X"
            )
    ...
    def test_valor_zero(self):
        ...
        with pytest.raises(ValueError, match="Valor deve ser positivo"):
            Lancamento(
                data=date.today(), valor=Decimal("0"), descricao="Teste", tipo="D"
            )
    ...
    def test_valor_negativo(self):
        ...
        with pytest.raises(ValueError, match="Valor deve ser positivo"):
            Lancamento(
                data=date.today(), valor=Decimal("-50"), descricao="Teste", tipo="D"
            )
    ...
    def test_descricao_vazia(self):
        ...
        with pytest.raises(ValueError, match="Descrição não pode estar vazia"):
            Lancamento(data=date.today(), valor=Decimal("100"), descricao="", tipo="D")

    def test_descricao_apenas_espacos(self):
        """Deve rejeitar descrição com apenas espaços."""
        with pytest.raises(ValueError, match="Descrição não pode estar vazia"):
            Lancamento(
                data=date.today(), valor=Decimal("100"), descricao="   ", tipo="D"
            )
    ...
    def test_valor_com_sinal_debito(self):
        ...
        lanc = Lancamento(
            data=date.today(), valor=Decimal("100"), descricao="Teste", tipo="D"
        )
    ...
    def test_valor_com_sinal_credito(self):
        ...
        lanc = Lancamento(
            data=date.today(), valor=Decimal("100"), descricao="Teste", tipo="C"
        )
    ...
    def test_to_dict(self):
        ...
        lanc = Lancamento(
            data=date(2025, 11, 2), valor=Decimal("150.50"), descricao="Teste", tipo="D"
        )
...
class TestComprovante:
    ...
    def test_arquivo_vazio(self):
        ...
        with pytest.raises(ValueError, match="Caminho do arquivo não pode estar vazio"):
            Comprovante(arquivo="", data=date.today(), valor=Decimal("100"))

    def test_valor_zero(self):
        """Deve rejeitar valor zero."""
        with pytest.raises(ValueError, match="Valor deve ser positivo"):
            Comprovante(arquivo="teste.pdf", data=date.today(), valor=Decimal("0"))

    def test_confianca_ocr_invalida_negativa(self):
        """Deve rejeitar confiança OCR negativa."""
        with pytest.raises(
            ValueError, match="Confiança OCR deve estar entre 0.0 e 1.0"
        ):
            Comprovante(
                arquivo="teste.pdf",
                data=date.today(),
    ...
    def test_extensao_arquivo(self):
        ...
        comp = Comprovante(
            arquivo="nf_123.pdf", data=date.today(), valor=Decimal("100")
        )
    ...
    def test_marcar_como_conciliado(self):
        ...
        comp = Comprovante(arquivo="teste.pdf", data=date.today(), valor=Decimal("100"))
...
class TestMatch:
    ...
    def test_criar_match_valido(self):
        ...
        comp = Comprovante(
            arquivo="nf_123.pdf", data=date(2025, 11, 2), valor=Decimal("150.50")
        )

        match = Match(lancamento=lanc, comprovante=comp, confianca=0.98, metodo="exato")
    ...
    def test_confianca_invalida_negativa(self):
        ...
        with pytest.raises(ValueError, match="Confiança deve estar entre 0.0 e 1.0"):
            Match(lancamento=lanc, comprovante=None, confianca=-0.5, metodo="exato")
    ...
    def test_metodo_invalido(self):
        ...
        with pytest.raises(ValueError, match="Método deve ser um dos seguintes"):
            Match(lancamento=lanc, comprovante=None, confianca=0.9, metodo="invalido")
    ...
    def test_nivel_confianca_alta(self):
        ...
        match = Match(lancamento=lanc, comprovante=None, confianca=0.95, metodo="exato")
    ...
    def test_requer_revisao_baixa_confianca(self):
        ...
        match = Match(lancamento=lanc, comprovante=None, confianca=0.75, metodo="fuzzy")
    ...
    def test_pode_auto_aprovar_nao(self):
        ...
        match = Match(lancamento=lanc, comprovante=None, confianca=0.85, metodo="fuzzy")
    ...
    def test_confirmar_match(self):
        ...
        match = Match(lancamento=lanc, comprovante=comp, confianca=0.95, metodo="exato")
