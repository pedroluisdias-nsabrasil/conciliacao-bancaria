...
class TestNormalizadores:
    ...
    def test_identificar_tipo_debito(self):
        ...
        assert (
            identificar_tipo_lancamento("PAGAMENTO FORNECEDOR", Decimal("100")) == "D"
        )
...
class TestIntegracaoLeitorCSV:
    ...
    def test_estatisticas_basicas(self, extrato_itau):
        ...
        # Calcular totais
        total_debitos = sum(l.valor for l in lancamentos if l.tipo == "D")
        total_creditos = sum(l.valor for l in lancamentos if l.tipo == "C")
