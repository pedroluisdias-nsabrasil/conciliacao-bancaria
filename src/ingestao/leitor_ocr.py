...
class LeitorOCR:
    ...
    def _extrair_de_imagem(
        ...
        logger.info(
            f"Comprovante extraído: valor=R${valor}, "
    ...
    def _extrair_texto(self, imagem: Image.Image) -> Tuple[str, float]:
        ...
        try:
            ...
            confidencias = [
                int(c) for c in dados['conf'] if c != '-1'
            ]
            ...
            logger.debug(f"Texto extraído: {len(texto)} caracteres, confiança={confianca:.0%}")
